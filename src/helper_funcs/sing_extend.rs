...
/// # Examples
/// ```
/// use lc3_vm_rust::helper_funcs::sing_extend::sing_extend;
///
/// assert_eq!(sing_extend(0b0_1111, 5), 0b0_1111);
/// assert_eq!(sing_extend(0b1_0000, 5), 0xFFF0);
/// ```
pub fn sing_extend(x: u16, bit_count: u16) -> u16 {
...
mod tests {
    ...
    fn sign_extend_one_bit_zero() {
        ...
        let value = 0b0u16;
        let extended = sing_extend(value, 1);
    ...
    fn sign_extend_positive_max_for_width() {
        ...
        let extended = sing_extend(value, 5);
